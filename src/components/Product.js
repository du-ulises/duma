      ...
      <div className="product-inner">
        <div className="product-content">
          <motion.div
            ...
            <h4 style={{fontFamily: "MADE Evolve Sans Regular", color: "#1779ff",}}>WE ARE DIGITAL IGNITION, OUR MISSION:</h4>
            <h2>BOOST YOUR BRAND</h2>
            <h4 style={{fontFamily: "MADE Evolve Sans Regular", color: "#1779ff",}}>WE ARE FUN PEOPLE THAT MAKES SERIOUS STUFF</h4>
